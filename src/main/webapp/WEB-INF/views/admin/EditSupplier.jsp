...
<div class="main-login main-center">
	<form method="post" action="aftersupplierEdit">
		<center>
			...
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-user fa"
						...
						name="id" id="id" value="${supplier.id }" readonly="true" />
				</div>
			</div>
		</div>

		<div class="form-group">
			<label for="name" class="cols-sm-2 control-label">Supplier
				Name</label>
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-user fa"
			...
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-lock fa"
						aria-hidden="true"></i></span> <input type="text" class="form-control"
						name="email" id="email" value="${supplier.email }"
			...
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i
						class="fa fa-address-card" aria-hidden="true"></i></span> <input
			...
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						type="text" class="form-control" name="contact" id="contact"
						value="${supplier.contact }" placeholder="Contact" />
				</div>
			</div>
		</div>
