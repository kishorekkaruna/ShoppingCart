...
<div class="main-login main-center">
	<form method="post" action="newSupplier">
		<center>
			...
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa  fa-envelope fa"
						...
						class="form-control" name="email" id="email" placeholder="email@mail.com" />
				</div>
			</div>
		</div>
			...
			<div class="cols-sm-10">
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-address-book"
						...
						class="form-control" name="contact" id="contact" placeholder="Contact" />
				</div>
			</div>
		</div>
